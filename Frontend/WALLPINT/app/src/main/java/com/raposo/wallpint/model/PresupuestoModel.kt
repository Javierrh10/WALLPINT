...
/**
 * Datos que el admin/pintor puede ajustar al convertir un presupuesto en DEFINITIVO.
 * Todos opcionales: si solo manda total, el back distribuye entre materiales y
 * mano de obra; si manda costes desglosados, calcula el total a partir de ellos.
 */
data class MarcarDefinitivoRequest(
    val nuevoTotal: Double? = null,
    val totalM2: Double? = null,
    val litrosPintura: Int? = null,
    val horasEstimadas: Double? = null,
    val numPintores: Int? = null,
